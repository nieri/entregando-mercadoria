...
public class ProcessaMenorRotaTest {
    ...
    public void deve_validar_parametros_nulos() {
        new ProcessaMenorRota(null, null, null);
    }

    @Test(expected=IllegalArgumentException.class)
    public void deve_validar_lista_vazia_de_rota() {
        new ProcessaMenorRota(new HashSet<Rota>(), null, null);
    }

    @Test
    public void deve_retornar_o_menor_caminho1() {
        String origem = "A";
        String destino = "D";
    ...
    @Test
    public void deve_retornar_o_menor_caminho2() {
        String origem = "A";
        String destino = "F";
        Set<Rota> rotas = new HashSet<Rota>();
